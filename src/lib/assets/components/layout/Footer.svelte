...
<footer class="py-8 sm:py-12 text-sm">
	<div class="container mx-auto">
		<div class="sm:flex sm:flex-wrap md:py-4 justify-between">
			<div class="px-4 sm:w-1/2 lg:w-1/4 xl:w-[285px] xl:px-0">
				<div class="mb-6">
			...
			<div class="px-4 sm:w-1/2 lg:w-1/4 xl:w-1/6 mt-8 sm:mt-0 xl:px-0">
				...
				<ul class="list-none footer-links">
					...
					<li class="mb-2">
						<a href="/pest-types">Pest Types</a>
					</li>
				</ul>
			</div>
			<div class="px-4 sm:w-1/2 lg:w-1/4 xl:w-1/6 mt-8 md:mt-0 xl:px-0">
			...
			<div class="px-4 sm:w-1/2 lg:w-1/4 xl:w-[362px] mt-8 md:mt-0 xl:px-0">
				...
				<div class="flex items-center my-5">
					<p class="text-gray">Write us</p>
					<a class="regular-btn ml-3" href="/contact">Contact</a>
				</div>
			</div>
		</div>

		<div class="mt-6 pt-6 sm:mt-12 sm:pt-12 border-t border-base-purple text-gray text-sm">
